<template>
    <div style="max-height:80vh;">
        ...
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
            <v-btn @click="addNewRow" small color="primary" :disabled="!hasRole('SalePerson')">
                <v-icon small>mdi-plus-circle-outline</v-icon>등록
            </v-btn>
            <v-btn  @click="editSelectedRow" small color="primary" :disabled="!hasRole('SalePerson')">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','salesOrderNumber','salesPerson','salesType','companyId','salesItem',]" />
        ...
        <SalesItemDetailGrid label="SalesItem" offline v-if="selectedRow" v-model="selectedRow.salesItem"/>
        <v-col>
            <v-dialog
                v-model="openDialog"
